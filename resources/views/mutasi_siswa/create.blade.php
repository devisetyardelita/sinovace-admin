...
<div class="content">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Formulir Tambah Data Mutasi Siswa</h4>
        ...
        <div class="row">
            ...
            <div class="card mb-4">
                ...
                <h5 class="mb-0">Data Mutasi Siswa</h5>
                </div>
                <div class="card-body">
                <form action="{{ url('mutasi_siswa/create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="file" id="surat_rekomendasi_sekolah_asal" name="surat_rekomendasi_sekolah_asal" class="form-control @error('surat_rekomendasi_sekolah_asal') is-invalid @enderror"  />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="file" id="surat_rekomendasi_sekolah_tujuan" name="surat_rekomendasi_sekolah_tujuan" class="form-control @error('surat_rekomendasi_sekolah_tujuan') is-invalid @enderror" />
                            <small style="color:gray"><p>File: pdf, jpg, jpeg, png.</p></small>

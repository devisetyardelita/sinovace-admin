...
<div class="content">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Formulir Tambah Data Legalisir Piagam Penghargaan</h4>
        ...
        <div class="row">
            ...
            <div class="card mb-4">
                ...
                <h5 class="mb-0">Data Legalisir Piagam Penghargaan</h5>
                </div>
                <div class="card-body">
                <form action="{{ url('legalisir_piagam_penghargaan/create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="file" id="piagam_penghargaan" name="piagam_penghargaan" class="form-control @error('piagam_penghargaan') is-invalid @enderror"  />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="file" id="fotokopi_piagam_penghargaan" name="fotokopi_piagam_penghargaan" class="form-control @error('fotokopi_piagam_penghargaan') is-invalid @enderror" />
                            <small style="color:gray"><p>File: pdf, jpg, jpeg, png.</p></small>

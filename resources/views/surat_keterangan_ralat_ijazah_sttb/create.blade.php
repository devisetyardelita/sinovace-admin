...
<div class="content">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Formulir Tambah Data Surat Keterangan Ralat Ijazah/STTB</h4>
        ...
        <div class="row">
            ...
            <div class="card mb-4">
                ...
                <h5 class="mb-0">Data Surat Keterangan Ralat Ijazah/STTB</h5>
                </div>
                <div class="card-body">
                <form action="{{ url('surat_keterangan_ralat_ijazah_sttb/create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">

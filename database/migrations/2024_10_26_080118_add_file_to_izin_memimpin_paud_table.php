...
return new class extends Migration
{
    ...
    {
        Schema::table('izin_memimpin_paud', function (Blueprint $table) {
            $table->after('no_hp', function($table){
                $table->string('surat_permohonan_yayasan')->nullable();
                $table->string('surat_pernyataan_bukan_pns')->nullable();
                $table->string('nuptk')->nullable();
                $table->string('sertifikat_pendidik')->nullable();
                $table->string('sertifikat_diklat_kepsek')->nullable();
    ...
    public function down(): void
    {
        Schema::table('izin_memimpin_paud', function (Blueprint $table) {
            ...
            $table->dropColumn('surat_pernyataan_bukan_pns');
            $table->dropColumn('nuptk');
            $table->dropColumn('sertifikat_pendidik');
            $table->dropColumn('sertifikat_diklat_kepsek');
